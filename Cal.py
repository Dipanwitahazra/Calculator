...
result_label = Label(root, text='', bg='grey', fg='black')
...
btn_add = Button(root, text='+', bg='#00a65a', fg='white', width=5, height=2, command=lambda: show('+'))
...
btn_sub = Button(root, text='-', bg='#00a65a', fg='white', width=5, height=2, command=lambda: show('-'))
...
btn_mul = Button(root, text='*', bg='#00a65a', fg='white', width=5, height=2, command=lambda: show('*'))
...
btn_div = Button(root, text='/', bg='#00a65a', fg='white', width=5, height=2, command=lambda: show('/'))
